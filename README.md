...
* **Gaussian** Signaling  
   The theoretical Shannon limit is

   $C = \frac{1}{2}\log_2(1+\text{SNR})$

* **BPSK** Modulation  
   A constellation with a **1 bit entropy ceiling**.

* **QPSK** Modulation  
   A constellation with a **2 bit entropy ceiling**.
